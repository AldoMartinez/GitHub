...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        //color del background de la barra de navegacion
        UINavigationBar.appearance().barTintColor = #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)
        //color de los items de la barra de navegacion (ej. boton de regresar)
        UINavigationBar.appearance().tintColor = UIColor.black
        
        //Color y fuente del titulo de la barra de navegacion
        if let barFont = UIFont(name: "Helvetica", size: 20){
